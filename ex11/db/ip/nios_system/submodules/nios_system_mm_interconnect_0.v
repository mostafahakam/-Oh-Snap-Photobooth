...
module nios_system_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_001_src_data;                                                                  // cmd_mux_001:src_data -> nios2_processor_jtag_debug_module_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                                 // nios2_processor_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [8:0] cmd_mux_001_src_channel;                                                               // cmd_mux_001:src_channel -> nios2_processor_jtag_debug_module_agent:cp_channel
	...
	wire          cmd_mux_003_src_valid;                                                                 // cmd_mux_003:src_valid -> key0_s1_agent:cp_valid
	wire  [105:0] cmd_mux_003_src_data;                                                                  // cmd_mux_003:src_data -> key0_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                                 // key0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                               // cmd_mux_003:src_channel -> key0_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                         // cmd_mux_003:src_startofpacket -> key0_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                           // cmd_mux_003:src_endofpacket -> key0_s1_agent:cp_endofpacket
	...
	wire  [106:0] hex_s1_agent_rf_source_data;                                                           // hex_s1_agent:rf_source_data -> hex_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex_s1_agent_rsp_fifo_out_data;                                                        // hex_s1_agent_rsp_fifo:out_data -> hex_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_004_src_data;                                                                  // cmd_mux_004:src_data -> hex_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                                 // hex_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                               // cmd_mux_004:src_channel -> hex_s1_agent:cp_channel
	...
	wire  [105:0] nios2_processor_jtag_debug_module_agent_rp_data;                                       // nios2_processor_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire          key0_s1_agent_rp_valid;                                                                // key0_s1_agent:rp_valid -> router_005:sink_valid
	wire  [105:0] key0_s1_agent_rp_data;                                                                 // key0_s1_agent:rp_data -> router_005:sink_data
	wire          key0_s1_agent_rp_ready;                                                                // router_005:sink_ready -> key0_s1_agent:rp_ready
	wire          key0_s1_agent_rp_startofpacket;                                                        // key0_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          key0_s1_agent_rp_endofpacket;                                                          // key0_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [105:0] hex_s1_agent_rp_data;                                                                  // hex_s1_agent:rp_data -> router_006:sink_data
	...
	wire          key0_s1_agent_rdata_fifo_src_valid;                                                    // key0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] key0_s1_agent_rdata_fifo_src_data;                                                     // key0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          key0_s1_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_003:in_0_ready -> key0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                     // avalon_st_adapter_003:out_0_valid -> key0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                      // avalon_st_adapter_003:out_0_data -> key0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                     // key0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                     // avalon_st_adapter_003:out_0_error -> key0_s1_agent:rdata_fifo_sink_error
